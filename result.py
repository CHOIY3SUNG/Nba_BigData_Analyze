...
def predict_game_outcomes(game_data):
    # Set the LeagueID to NBA (1)
    league_id = "00"

    # Retrieve all NBA games until the 2022 season
    game_finder = LeagueGameFinder(league_id_nullable=league_id)
    games = game_finder.get_data_frames()[0]

    # Filter games until the 2022 season
    ...
    # Scale the game data using the same scaler object
...
# # Call the function to predict game outcomes
# predict_game_outcomes(game_data)
